...
echo   - %current_dir%\installer_files\Env >> "%current_dir%\installer_files\Miniconda\.condarc"
echo pkgs_dirs: >> "%current_dir%\installer_files\Miniconda\.condarc"
echo   - %current_dir%\installer_files\conda\pkgs >> "%current_dir%\installer_files\Miniconda\.condarc"

echo .condarc file has been updated with the following paths:
echo Environment directory: %current_dir%\installer_files\Env
